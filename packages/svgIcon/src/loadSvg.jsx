...
const icons = {
  ...
  loading: '<svg viewBox="0 -2 59.75 60.25"><path d="M29.69-.527C14.044-.527 1.36 12.158 1.36 27.806S14.043 56.14 29.69 56.14c15.65 0 28.334-12.686 28.334-28.334S45.34-.527 29.69-.527zm.185 53.75c-14.037 0-25.417-11.38-25.417-25.417S15.838 2.39 29.875 2.39s25.417 11.38 25.417 25.417-11.38 25.416-25.417 25.416z"/><path  stroke="#108ee9" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" d="M56.587 29.766c.37-7.438-1.658-14.7-6.393-19.552"/></svg>',
  ...
  dislike: '<svg viewBox="0 0 72 72"><g  fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" /><path  d="M47 22h2v6h-2zm-24 0h2v6h-2z"/><path d="M21 51s4.6-7 15-7 15 7 15 7" stroke="#FFF" stroke-width="2"/></g></svg>',
  fail: '<svg viewBox="0 0 72 72"><g  fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" /><path d="M22 22l28.304 28.304m-28.304 0L50.304 22" stroke="#FFF" stroke-width="2"/></g></svg>',
  success: '<svg viewBox="0 0 72 72"><g  fill-rule="evenodd"><path d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36zm0-2c18.778 0 34-15.222 34-34S54.778 2 36 2 2 17.222 2 36s15.222 34 34 34z" /><path stroke="#FFF" stroke-width="2" d="M19 34.54l11.545 11.923L52.815 24"/></g></svg>',
};
...
const svgSprite = () => `
    ...
    >
    <defs id="__ANTD_MOBILE_SVG_SPRITE_NODE__">
        
    </defs>
    </svg>
`;
const renderSvg = (type) => {
  const id = `${type}_symbol_`;
...
const loadSvg = (type) => {
  ...
  let defsNode = document.getElementById('__ANTD_MOBILE_SVG_SPRITE_NODE__');
  const mountNode = document.body;
  if (!defsNode) {
    mountNode.insertAdjacentHTML('afterbegin', svgSprite());
  }
  defsNode = document.getElementById('__ANTD_MOBILE_SVG_SPRITE_NODE__');
  const existing = document.getElementById(`${type}_symbol_`);
  console.log('existingexisting', existing);
  if (!existing && defsNode) {
    defsNode.insertAdjacentHTML('afterbegin', renderSvg(type));
  }
};
